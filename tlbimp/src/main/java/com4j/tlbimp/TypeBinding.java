...
/**
 * Represents how a type is bound between native type and Java type.
 *
...
final class TypeBinding {
	...
	/**
	 * True if the {@link #nativeType} is the default native type for the
	 * {@link #javaType}.
	 */
	 ...
	 *
	 * @param nameHint
	 *            Optional parameter name of the type. If non-null, this is used
	 *            to disambiguate common mistake like declaring LPWSTR as
	 *            "ushort*", etc.
	 */
	public static TypeBinding bind(Generator g, IType t, String nameHint) throws BindingException {
		
		if("tagTYPEATTR**".equals(getTypeString(t))) {
	...
	/**
	 * Returns a human-readable identifier of the type, but it's not necessarily
	 * a correct Java id.
	 *
	 ...
	 */
	private static final Map<VarType, TypeBinding> primitiveTypeBindings = new EnumMap<VarType, TypeBinding>(VarType.class);
